...
sudo timeshift --create --comments "System Init" || exit_on_error "Failed to create a timeshift snapshot (System Init)"
...
cd ~/Desktop/hyprdots/Scripts || exit_on_error "Failed to change directory to Hyprdots/Scripts"
